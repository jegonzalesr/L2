...
void ajusteDeInventarioPositivo () {
    ...
    system("cls");
    cout << endl;
    cout << "Ajuste de Inventario positivo" << endl;
    cout << "**********************************" << endl;
    cout << "Consultar el codigo del producto: ";
    cin >> codigo;
    cout << endl;
    cout << "Desea actualizar la cantidad del producto en el inventario: ";
    cin >> cantidad;
    cout << endl;
...
void ajusteDeInventarioNegativo() {
    ...
    system("cls");
    cout << endl;
    cout << "Ajuste de Inventario Negativo" << endl;
    cout << "**********************************" << endl;
    cout << "Consultar el codigo del producto: ";
    cin >> codigo;
    cout << endl;
