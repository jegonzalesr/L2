...
void cargarLibros() {
	...
	libros[0][0] = "Algoritmos"; libros[0][1] = "Algoritmos y Programacion (Guia para docentes)";libros[0][2] = "Max Tegmark";                                       
	libros[1][0] = "Algoritmos"; libros[1][1] = "Apuntes de Algoritmos y Estructuras de Datos";  libros[1][2] = "Hans Rosling";
	libros[2][0] = "Algoritmos"; libros[2][1] = "Breves Notas sobre Analisis de Algoritmos";     libros[2][2] = "Jose Ignacio Latorre";
	libros[3][0] = "Algoritmos"; libros[3][1] = "Fundamentos de Informatica y Programacion";     libros[3][2] = "Steve Jobs";
...
int main(int argc, char const *argv[])
{
    ...
    while (salir == false)
    {
        ...
        for (int i = 0; i < 39; i++)
        {
            ...
            if (libroEnminuscula.find(buscar) != string::npos || autorEnminiscula.find(buscar) != string::npos) {
